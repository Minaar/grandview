                                        ...
                                        <div class="card-content px-36">
                                                    ...
                                                    <div class="invoice-date-picker display-flex align-items-center">
                                                        <div class="display-flex align-items-center">
                                                            ...
                                                            <div class="display-flex ml-4">
                                                                <input type="text" class="datepicker mr-2 mb-1"
                                                        ...
                                                        <div class="display-flex align-items-center">
                                                            ...
                                                            <div class="display-flex ml-4">
                                                                <input type="text" class="datepicker mb-1"
                                                                    placeholder="Select Date">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col m6 s12 invoice-logo display-flex pt-1 push-m6">
                                                    <img src="../../../app-assets/images/gallery/pixinvent-logo.png"
                                            ...
                                            <div class="invoice-product-details mb-3">
                                                <form class="form invoice-item-repeater">
                                                            ...
                                                            <div class="invoice-item display-flex mb-1">
                                                                <div class="invoice-item-filed row pt-1">
                                                                    <div class="col s12 m4 input-field">
                                                                        <select
                                                                            class="invoice-item-select browser-default">
                                                                            <option value="Frest Admin Template">Frest
                                                                                Admin Template</option>
                                                                            <option value="Stack Admin Template">Stack
                                                                                Admin Template</option>
                                                                            <option value="Robust Admin Template">Robust
                                                                                Admin Template</option>
                                                                            <option value="Apex Admin Template">Apex Admin
                                                                                Template</option>
                                                                            <option value="Modern Admin Template">Modern
                                                                                Admin Template</option>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-content"
                                                                            ...
                                                                            <div class="row mr-0 ml-0">
                                                                                ...
                                                                                <div class="col s6">
                                                                                    <select id="Tax1"
                                                                                        class="invoice-tax browser-default">
                                                                                        <option value="0%"
                                                                                            selected=""
                                                                                            disabled="">Tax1</option>
                                                                            ...
                                                                            <div
                                                                                class="display-flex justify-content-between mt-4">
                                                                                <button type="button"
                                                                                    class="btn invoice-apply-btn">
                                                                                    <span>Apply</span>
                                                                                </button>
                                                                                <button type="button"
                                                                                    class="btn invoice-cancel-btn ml-1 indigo">
                                                                                    <span>Cancel</span>
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="input-field">
                                                        <button class="btn invoice-repeat-btn" data-repeater-create=""
                                                            type="button">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class=" mt-2">
                                                                <a href="app-invoice-view.html"
                                                                    class="btn btn-block waves-effect waves-light">Preview</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
